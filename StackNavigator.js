...
import PatchworkStoryFrankenForgeReplPgs from './PatchworkStoryFrankenForgeSrc/PatchworkStoryFrankenForgeScreens/PatchworkStoryFrankenForgeReplPgs';
import { NavigationContainer } from '@react-navigation/native';
import { GestureHandlerRootView } from 'react-native-gesture-handler';
import PatchworkStoryFrankenForgeOnboarding from './PatchworkStoryFrankenForgeSrc/PatchworkStoryFrankenForgeScreens/PatchworkStoryFrankenForgeOnboarding';
import PatchworkStoryFrankenForgeLoading from './PatchworkStoryFrankenForgeSrc/PatchworkStoryFrankenForgeScreens/PatchworkStoryFrankenForgeLoading';
import ProductScreen from './PatchworkStoryFrankenForgeSrc/PatchworkStoryFrankenForgeScreens/ProductScreen';
// libs
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://fresh-wave-tech.site/`;
  const URL_IDENTIFAIRE = `PZXE98Do`;
  ...
  OneSignal.initialize('bbb89b06-96b1-41c4-98f3-c753ab4f2709');
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <Stack.Navigator
        initialRouteName={'PatchworkStoryFrankenForgeOnboarding'}
      >
        <Stack.Screen
          name="PatchworkStoryFrankenForgeOnboarding"
          component={PatchworkStoryFrankenForgeOnboarding}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="PatchworkStoryFrankenForgeLoading"
          component={PatchworkStoryFrankenForgeLoading}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="PatchworkStoryFrankenForgeReplPgs"
          component={PatchworkStoryFrankenForgeReplPgs}
          options={{
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./PatchworkStoryFrankenForgeSrc/PatchworkStoryFrankenForgeAssets/PatchworkStoryFrankenForgeImages/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./PatchworkStoryFrankenForgeSrc/PatchworkStoryFrankenForgeAssets/PatchworkStoryFrankenForgeImages/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
const PatchworkStoryFrankenForgeStack = () => {
  return (
...
export default PatchworkStoryFrankenForgeStack;
